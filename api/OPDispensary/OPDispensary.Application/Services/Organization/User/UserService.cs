...
public class UserService : DbRepository<SysUser>, IUserService
{
    ...
    public UserService(ISysUserService sysUserService, ISysRoleService sysRoleService,
    ...
    private async Task CheckInput(SysUser sysUser, string operate)
    {
        ...
        if (sysUser.Id != OPDispensaryConst.ZERO)
        {
    ...
    /// <returns></returns>
    public async Task<List<BizUserImportInput>> CheckImport(List<BizUserImportInput> data, List<long> dataScope,
