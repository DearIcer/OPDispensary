...
public static class DbContext
{
    ...
    /// </summary>
    public static readonly List<SqlSugarConfig> DB_CONFIGS =
        App.GetConfig<List<SqlSugarConfig>>("SqlSugarSettings:ConnectionStrings");

    /// <summary>
    ///     SqlSugar 数据库实例
    /// </summary>
    public static readonly SqlSugarScope DB = new(DB_CONFIGS.Adapt<List<ConnectionConfig>>(), db =>
    {
        //遍历配置的数据库
