...
public class SM2CryptoUtil
{
    ...
    private class Cipher
    {
        ...
        public static byte[] byteConvert32Bytes(BigInteger n)
        {
            ...
            {
                tmpd = new byte[32];
                for (var i = 0; i < 32 - n.ToByteArray().Length; i++) tmpd[i] = 0;
    ...
    private class SM2
    {
        ...
        public readonly string[] ecc_param = sm2_param;
        ...
        public static SM2 Instance => new();

        public static SM2 InstanceTest => new();
