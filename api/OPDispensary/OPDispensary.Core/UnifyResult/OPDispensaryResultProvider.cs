...
namespace OPDispensary.Core;

/// <summary>
///     规范化RESTful风格返回值
/// </summary>
[SuppressSniffer]
[UnifyModel(typeof(OPDispensaryResult<>))]
public class OPDispensaryResultProvider : IUnifyResultProvider
{
    ...
    /// <returns></returns>
    private static OPDispensaryResult<object> ResTfulResult(int statusCode, bool succeeded = default,
        object data = default,
        object errors = default)
    {
        return new OPDispensaryResult<object>
        {
            Code = statusCode,
